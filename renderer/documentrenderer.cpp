...
DocumentRenderer::DocumentRenderer(QTextDocument* textdocument, const RDDisassemblerPtr& disassembler, RDCursor* cursor, rd_flag flags): QtRenderer(disassembler, cursor, flags), m_textdocument(textdocument) { }
